...
from fleak.attack.GGL_CLASS import GGL_reconstruction,BOReconstructor
...
def GGLreconstruction(global_model, generator, shared_gradients, device="cpu", budget=500, use_tanh=True):
    ...
    ggl_reconstruct = BOReconstructor(fl_model=global_model, generator=generator, loss_fn=loss_fn, search_dim=(100,), budget=budget, use_tanh=use_tanh)
