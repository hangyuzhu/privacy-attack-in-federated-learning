...
from .test_optimizer import (Optimizer, required, _use_grad_for_differentiable, _default_to_fused_or_foreach,
...
class MySGD(Optimizer):
    ...
    def _init_group(self, group, params_with_grad, d_p_list, grads, momentum_buffer_list):
    ...
    def step(self, closure=None, grads=None):
        ...
        for group in self.param_groups:
            ...
            has_sparse_grad = self._init_group(group, params_with_grad, d_p_list, grads, momentum_buffer_list)
