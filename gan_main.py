...
#             for i in range(9):
#                 plt.subplot(3, 3, i + 1)
#                 ndarr = gen_imgs[i].mul(255).add_(0.5).clamp_(0, 255).permute(1, 2, 0).to("cpu", torch.uint8).numpy()
...
dataset = dset.MNIST(root='../federated_learning/data/mnist', download=True,
                     transform=transforms.Compose([
                         transforms.ToTensor(),
